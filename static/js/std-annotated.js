    ...
    "PDF": {
        ...
        "openAction": {
            ...
            "arguments": [
                {
                    "type": "string",
                    "desc": "Note that Prince passes the provided values verbatim to the PDF viewer, so the user can supply values that Prince doesn't know about, but the viewer does."
                }
            ],
        ...
        "pageLayout": {
            ...
            "arguments": [
                {
                    "type": "string",
                    "desc": "\"single-page\" | \"one-column\" | \"two-column[-left/right]\""
                }
            ]
        },
        "pageMode": {
            ...
            "arguments": [
                {
                    "type": "string",
                    "desc": "\"auto\" | \"show-bookmarks\" | \"fullscreen\" | \"show-attachments\""
                }
            ]
        },
        "printScaling": {
        ...
        "duplex": {
            ...
            "arguments": [
                {
                    "type": "string",
                    "desc": "\"auto\" | \"simplex\" | \"duplex-flip-short-edge\" | \"duplex-flip-long-edge\""
                }
            ]
        },
        "profile": {
            ...
            "arguments": [
                {
                    "type": "string",
                    "desc": "One of the supported PDF profiles."
                }
            ],
        ...
        "paperTray": {
            ...
            "arguments": [
                {
                    "type": "string",
                    "desc": "\"auto \" | \"pick-tray-by-pdf-size\""
                }
            ]
        },
        "filterResolution": {
