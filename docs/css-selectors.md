...
<td>This micro-syntax to indicate indexes in a list of sibling elements represents an integer <code>step (A)</code> and <code>offset (B)</code>, i.e. it indicates the <code><i>An+B</i></code>th elements in a list. It also takes the keywords <code>odd</code> and <code>even</code>.</td>
</tr>
<tr>
...
<tr>
<td><code style={{whiteSpace: "nowrap"}}>:any-link</code></td>
