...
<dl className="faq">
  ...
  <a href="#faq-win64" className="self-link"></a></p></dt>
  ...
  <a href="#faq-win-no-ui" className="self-link"></a></p></dt>
  ...
  containers (Azure, AWS, Docker)? <a href="#faq-install-cloud" className="self-link"></a></p></dt>
  ...
  <a href="#faq-install-books" className="self-link"></a></p></dt>
  ...
  <a href="#faq-install-wrappers" className="self-link"></a></p></dt>
