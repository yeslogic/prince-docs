...
-   The section addresses possible common issues after installing and starting to use Prince;
-   The section provides answers to the most frequently asked questions about installation;
