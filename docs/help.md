...
-   The [Troubleshooting](troubleshooting.html#troubleshooting) section addresses possible common issues after installing and starting to use Prince;
-   The [Frequently Asked Questions](faq.html#faq) section provides answers to the most frequently asked questions;
