...
-   The [Troubleshooting](troubleshooting.md#troubleshooting) section addresses possible common issues after installing and starting to use Prince;
-   The [Frequently Asked Questions](faq.md#faq) section provides answers to the most frequently asked questions;
