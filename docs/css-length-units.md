...
* the CSS [`transform`](css-props.md#prop-transform) property has `rotate` and `skew` operators;
...
* the `@page` [`-prince-rotate-body`](css-props.md#prop-prince-rotate-body) property takes multiples of `90deg`.
