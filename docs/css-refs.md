...
<div className="mdxCodeBlock_node_modules-@docusaurus-theme-classic-lib-theme-MDXComponents-"><div className="codeBlockContent_node_modules-@docusaurus-theme-classic-lib-theme-CodeBlock-"><button type="button" aria-label="Copy code to clipboard" className="copyButton_node_modules-@docusaurus-theme-classic-lib-theme-CodeBlock-">Copy</button><div tabIndex={0} className="prism-code language-undefined codeBlock_node_modules-@docusaurus-theme-classic-lib-theme-CodeBlock-"><div className="codeBlockLines_node_modules-@docusaurus-theme-classic-lib-theme-CodeBlock-" style={{color: 'rgb(191, 199, 213)', backgroundColor: 'rgb(41, 45, 62)'}}><div className="token-line" style={{color: 'rgb(191, 199, 213)'}}><span className="token plain">h4::before {'{'} counter(h4, repeat("x", "y", "z")) {'}'}</span></div></div></div></div></div>
<p class="comment">
...
<div className="mdxCodeBlock_node_modules-@docusaurus-theme-classic-lib-theme-MDXComponents-"><div className="codeBlockContent_node_modules-@docusaurus-theme-classic-lib-theme-CodeBlock-"><button type="button" aria-label="Copy code to clipboard" className="copyButton_node_modules-@docusaurus-theme-classic-lib-theme-CodeBlock-">Copy</button><div tabIndex={0} className="prism-code language-undefined codeBlock_node_modules-@docusaurus-theme-classic-lib-theme-CodeBlock-"><div className="codeBlockLines_node_modules-@docusaurus-theme-classic-lib-theme-CodeBlock-" style={{color: 'rgb(191, 199, 213)', backgroundColor: 'rgb(41, 45, 62)'}}><div className="token-line" style={{color: 'rgb(191, 199, 213)'}}><span className="token plain">h4::before {'{'} counter(h4, symbols("x", "y", "z")) {'}'}</span></div></div></div></div></div>
<p class="comment">
...
<div className="mdxCodeBlock_node_modules-@docusaurus-theme-classic-lib-theme-MDXComponents-"><div className="codeBlockContent_node_modules-@docusaurus-theme-classic-lib-theme-CodeBlock-"><button type="button" aria-label="Copy code to clipboard" className="copyButton_node_modules-@docusaurus-theme-classic-lib-theme-CodeBlock-">Copy</button><div tabIndex={0} className="prism-code language-undefined codeBlock_node_modules-@docusaurus-theme-classic-lib-theme-CodeBlock-"><div className="codeBlockLines_node_modules-@docusaurus-theme-classic-lib-theme-CodeBlock-" style={{color: 'rgb(191, 199, 213)', backgroundColor: 'rgb(41, 45, 62)'}}><div className="token-line" style={{color: 'rgb(191, 199, 213)'}}><span className="token plain">img {'{'}</span></div><div className="token-line" style={{color: 'rgb(191, 199, 213)'}}><span className="token plain">  content: prince-fallback(attr(src, url)),</span></div><div className="token-line" style={{color: 'rgb(191, 199, 213)'}}><span className="token plain">           attr(data-altsrc, url)</span></div><div className="token-line" style={{color: 'rgb(191, 199, 213)'}}><span className="token plain">{'}'}</span></div></div></div></div></div>
</td>
</tr>
<tr class="ext">
...
formats.
<div className="mdxCodeBlock_node_modules-@docusaurus-theme-classic-lib-theme-MDXComponents-"><div className="codeBlockContent_node_modules-@docusaurus-theme-classic-lib-theme-CodeBlock-"><button type="button" aria-label="Copy code to clipboard" className="copyButton_node_modules-@docusaurus-theme-classic-lib-theme-CodeBlock-">Copy</button><div tabIndex={0} className="prism-code language-undefined codeBlock_node_modules-@docusaurus-theme-classic-lib-theme-CodeBlock-"><div className="codeBlockLines_node_modules-@docusaurus-theme-classic-lib-theme-CodeBlock-" style={{color: 'rgb(191, 199, 213)', backgroundColor: 'rgb(41, 45, 62)'}}><div className="token-line" style={{color: 'rgb(191, 199, 213)'}}><span className="token plain">@font-face {'{'}</span></div><div className="token-line" style={{color: 'rgb(191, 199, 213)'}}><span className="token plain">  font-family: bodytext;</span></div><div className="token-line" style={{color: 'rgb(191, 199, 213)'}}><span className="token plain">  src: url(sans-serif-font.ttf) format("opentype");</span></div><div className="token-line" style={{color: 'rgb(191, 199, 213)'}}><span className="token plain">{'}'}</span></div></div></div></div></div>
</td>
